...
keep if All==1 & `regvar'<=17 & allmatches50_onlyMover==1
	
*----------------------*
*FIGURE 7
*----------------------*
#d ;
	eststo : reghdfe top10FnamNtvpAl20AllDv ib1.`regvar' chorder, absorb(dupmatches50 sex famid50 relchorder150) cluster(famid50 Ct);
	...
	qui graph export "$outdirnber/figure7.pdf", replace;
#d cr
...
eststo clear
 ...
 #d ;
	esttab using "$outdirnber/table8.tex", 
